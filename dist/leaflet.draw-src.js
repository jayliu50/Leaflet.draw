/*
 Leaflet.draw 0.4.9a, a plugin that adds drawing and editing tools to Leaflet powered maps.
...
L.Draw.Feature = L.Handler.extend({
	...
	removeHooks: function () {
		if (this._map) {
			...
			// todo: fix this hack. _tooltip shouldn't be undefined
			if (this._tooltip) {
...
L.Draw.SimpleShapeTap = L.Draw.Feature.extend({
	...
	removeHooks: function () {
		...
		if (this._map) {
			...
			this._map
				...
				.off('click', this._onTouchEnd, this);
		}
	},
	...
	_onTouchEnd: function (e) {
		...
		var clientX;
		var clientY;
		if (originalEvent.touches && originalEvent.touches[0] && !this._multiTouch && !this._clickHandled && !this._touchHandled && !this._disableMarkers) {
	...
	_onTouchStart: function(e) {
		this._multiTouch = (e.originalEvent.touches.length > 1);
	},
